...
#define DBMDX_CHDEV_OPT_DEFAULT				0x0000
#define DBMDX_CHDEV_OPT_DEV0_MP				0x0001
#define DBMDX_CHDEV_OPT_DEV1_MP				0x0002
#define DBMDX_CHDEV_OPT_DEV0_BLOCKING			0x0004
#define DBMDX_CHDEV_OPT_DEV1_NON_BLOCKING		0x0008
#define DBMDX_CHDEV_OPT_CONT_BUFFERING_ON_DEV0_RELEASE	0x0010
#define DBMDX_CHDEV_OPT_CONT_BUFFERING_ON_DEV1_RELEASE	0x0020

#define DBMDX_UEVENT_OPT_SEND_DETECTION_EVENT		0x0001
#define DBMDX_UEVENT_OPT_SEND_AFTER_PASSPHRASE_READY	0x0002
#define DBMDX_UEVENT_OPT_SEND_BUFFERING_DONE_EVENT	0x0004

#define DBMDX_BUFFERING_OPT_DEFAULT			0x0000
#define DBMDX_BUFFERING_OPT_SPLIT_PASSPHRASE		0x0001
#define DBMDX_BUFFERING_OPT_DUPLICATE_BUFFER		0x0002

#define DBMDX_AVD_OPT_DEFAULT				0x0000
#define DBMDX_AVD_OPT_SPLIT_PASSPHRASE_BUFFER		0x0001
#define DBMDX_AVD_OPT_DUPLICATE_DETECTION_BUFFER	0x0002
#define DBMDX_AVD_OPT_SEND_DETECTION_UEVENT		0x0004
#define DBMDX_AVD_OPT_SEND_BUFFERING_DONE_UEVENT	0x0008
#define DBMDX_AVD_OPT_SEND_DET_UEVENT_AFTER_PASSPHRASE	0x0010
...
struct va_flags {
	...
	int	cancel_pm_work;
	unsigned int	mode;
	unsigned int	det_uevent_in_sv_work;
};
...
struct dbmdx_private {
	...
	dev_t				record_chrdev;
	struct cdev			record_cdev0;
	struct device			*record_dev0;
	struct cdev			record_cdev1;
	struct device			*record_dev1;
	...
	bool				multipurpose_kfifo_in_use;
	struct kfifo			multipurpose_samples_kfifo;
	void				*multipurpose_samples_kfifo_buf;
	unsigned int			multipurpose_samples_kfifo_buf_size;
	...
	u32				chdev_options;
	u32				uevent_options;
	u32				buffering_options;
	u32				pre_backlog_time_ms;
	u32				post_backlog_time_ms;
