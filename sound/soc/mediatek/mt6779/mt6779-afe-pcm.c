...
//
// Mediatek ALSA SoC AFE platform driver for 6779
//
...
static int mt6779_afe_pcm_platform_probe(struct snd_soc_platform *platform)
{
	mtk_afe_add_sub_dai_control(platform);
	mt6779_add_misc_control(platform);
	return 0;
}

const struct snd_soc_platform_driver mt6779_afe_pcm_platform = {
	.ops = &mtk_afe_pcm_ops,
	.pcm_new = mtk_afe_pcm_new,
	.pcm_free = mtk_afe_pcm_free,
	.probe = mt6779_afe_pcm_platform_probe,
};
