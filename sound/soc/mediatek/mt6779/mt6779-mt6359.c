...
//
// mt6779-mt6359.c  --  mt6779 mt6359 ALSA SoC machine driver
//
...
static const char *const mt6779_spk_i2s_type_str[] = {MTK_SPK_I2S_0_STR,
						      MTK_SPK_I2S_1_STR,
						      MTK_SPK_I2S_2_STR,
						      MTK_SPK_I2S_3_STR,
						      MTK_SPK_I2S_5_STR};
...
static const struct snd_soc_dapm_widget mt6779_mt6359_widgets[] = {
	SND_SOC_DAPM_SPK(EXT_SPK_AMP_W_NAME, mt6779_mt6359_spk_amp_event),
};

static const struct snd_soc_dapm_route mt6779_mt6359_routes[] = {
...
static const struct snd_kcontrol_new mt6779_mt6359_controls[] = {
	SOC_DAPM_PIN_SWITCH(EXT_SPK_AMP_W_NAME),
	SOC_ENUM_EXT("MTK_SPK_TYPE_GET", mt6779_spk_type_enum[0],
		     mt6779_spk_type_get, NULL),
	SOC_ENUM_EXT("MTK_SPK_I2S_OUT_TYPE_GET", mt6779_spk_type_enum[1],
...
static const struct snd_soc_ops mt6779_mt6359_i2s_ops = {
	.hw_params = mt6779_mt6359_i2s_hw_params,
};

static int mt6779_mt6359_mtkaif_calibration(struct snd_soc_pcm_runtime *rtd)
{
	...
	mt6779_afe_gpio_request(afe, true, MT6779_DAI_ADDA, 1);
	mt6779_afe_gpio_request(afe, true, MT6779_DAI_ADDA, 0);
	mt6779_afe_gpio_request(afe, true, MT6779_DAI_ADDA_CH34, 1);
	mt6779_afe_gpio_request(afe, true, MT6779_DAI_ADDA_CH34, 0);
	...
	mt6779_afe_gpio_request(afe, false, MT6779_DAI_ADDA, 1);
	mt6779_afe_gpio_request(afe, false, MT6779_DAI_ADDA, 0);
	mt6779_afe_gpio_request(afe, false, MT6779_DAI_ADDA_CH34, 1);
	mt6779_afe_gpio_request(afe, false, MT6779_DAI_ADDA_CH34, 0);
...
static int mt6779_mt6359_init(struct snd_soc_pcm_runtime *rtd)
{
	...
	if (afe_priv->mtkaif_protocol == MTKAIF_PROTOCOL_2_CLK_P2)
		mt6779_mt6359_mtkaif_calibration(rtd);
...
static int mt6779_i2s_hw_params_fixup(struct snd_soc_pcm_runtime *rtd,
				      struct snd_pcm_hw_params *params)
{
...
struct snd_soc_dai_link_component tfa98xx_iic[] = {
	{
		.of_node = NULL,
		.name = "tfa98xx.6-0035",
		.dai_name = "tfa98xx-aif-6-35",
...
static struct snd_soc_dai_link tfa98xx_dai_link_iic[] = {
    {
        .name = "I2S3",
        .cpu_dai_name = "I2S3",
#ifdef CONFIG_SND_SOC_ALSACODEC_TFA9890
		.codecs = tfa98xx_iic,
		.num_codecs = ARRAY_SIZE(tfa98xx_iic),
#else /* CONFIG_SND_SOC_ALSACODEC_TFA9890 */
		.codec_dai_name = "snd-soc-dummy-dai",
		.codec_name = "snd-soc-dummy",
#endif /* CONFIG_SND_SOC_ALSACODEC_TFA9890 */
...
static struct snd_soc_card mt6779_mt6359_soc_card = {
	.name = "mt6779-mt6359",
	.owner = THIS_MODULE,
	.dai_link = mt6779_mt6359_dai_links,
	.num_links = ARRAY_SIZE(mt6779_mt6359_dai_links),

	.controls = mt6779_mt6359_controls,
	.num_controls = ARRAY_SIZE(mt6779_mt6359_controls),
	.dapm_widgets = mt6779_mt6359_widgets,
	.num_dapm_widgets = ARRAY_SIZE(mt6779_mt6359_widgets),
	.dapm_routes = mt6779_mt6359_routes,
	.num_dapm_routes = ARRAY_SIZE(mt6779_mt6359_routes),
};
...
static int mt6779_mt6359_dev_probe(struct platform_device *pdev)
{
	...
	for (i = 0; i < card->num_links; i++) {
		if (mt6779_mt6359_dai_links[i].platform_name)
			continue;
		mt6779_mt6359_dai_links[i].platform_of_node = platform_node;
	}
	...
	for (i = 0; i < card->num_links; i++) {
		...
		if (tfa98xx_dual_spk) {
			...
			if (tfa98xx_i2cbus == 6) {
				if (!strcmp(mt6779_mt6359_dai_links[i].name, "I2S3")) {
					memcpy(&mt6779_mt6359_dai_links[i], &tfa98xx_dai_link_iic[0],
						sizeof(tfa98xx_dai_link_iic[0]));
					dev_info(card->dev, "%s: use tfa98xx_dai_link_iic replace for tfa98xx\n", __func__);
					continue;
				}
			}
		}
...
#ifdef CONFIG_OF
static const struct of_device_id mt6779_mt6359_dt_match[] = {
	{.compatible = "mediatek,mt6779-mt6359-sound",},
	{}
};
#endif

static const struct dev_pm_ops mt6779_mt6359_pm_ops = {
	.poweroff = snd_soc_poweroff,
	.restore = snd_soc_resume,
};

static struct platform_driver mt6779_mt6359_driver = {
	.driver = {
		.name = "mt6779-mt6359",
#ifdef CONFIG_OF
		.of_match_table = mt6779_mt6359_dt_match,
#endif
		.pm = &mt6779_mt6359_pm_ops,
	},
	.probe = mt6779_mt6359_dev_probe,
};

module_platform_driver(mt6779_mt6359_driver);

/* Module information */
MODULE_DESCRIPTION("MT6779 MT6359 ALSA SoC machine driver");
MODULE_AUTHOR("KaiChieh Chuang <kaichieh.chuang@mediatek.com>");
MODULE_LICENSE("GPL v2");
MODULE_ALIAS("mt6779 mt6359 soc card");
