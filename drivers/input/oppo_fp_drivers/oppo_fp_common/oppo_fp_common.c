...
#if CONFIG_OPPO_FINGERPRINT_PLATFORM == 6763 || CONFIG_OPPO_FINGERPRINT_PLATFORM == 6771 || CONFIG_OPPO_FINGERPRINT_PLATFORM == 6779 || CONFIG_OPPO_FINGERPRINT_PLATFORM == 6785 || CONFIG_OPPO_FINGERPRINT_PLATFORM == 6765
...
#define ENGINEER_MENU_CHIPONE_7332   "-1,-1"
...
#if CONFIG_OPPO_FINGERPRINT_PLATFORM == 6765
	int g_fingerprint = -1;
#endif
...
#elif CONFIG_OPPO_FINGERPRINT_PLATFORM == 6765
fp_module_config_t fp_module_config_list[] = {
	{{1, -1, -1},  FP_CHIPONE_7332,    	CHIP_CHIPONE,    ENGINEER_MENU_CHIPONE_7332},
	{{0, -1, -1},  FP_EGIS_520,			CHIP_EGIS,  	 ENGINEER_MENU_EGIS_520},
};
#else
fp_module_config_t fp_module_config_list[] = {
    ...
    for (i = 0; i < sizeof(fp_module_config_list)/sizeof(fp_module_config_t); ++i) {
        if ((fp_module_config_list[i].gpio_id_config_list[0] == fp_id1) &&
            ...
            switch (fp_module_config_list[i].fp_vendor_chip) {
				...
				case FP_CHIPONE_7332:
					strncpy(fp_manu, CHIP_CHIPONE, FP_ID_MAX_LENGTH - FP_ID_SUFFIX_MAX_LENGTH);
                    strncat(fp_manu, "_7332", FP_ID_SUFFIX_MAX_LENGTH - 1);
                    strncpy(g_engineermode_menu_config, fp_module_config_list[i].engineermode_menu_config, ENGINEER_MENU_SELECT_MAXLENTH - 1);
                    return FP_CHIPONE_7332;
                default:
...
#if CONFIG_OPPO_FINGERPRINT_PLATFORM == 6763 || CONFIG_OPPO_FINGERPRINT_PLATFORM == 6771 || CONFIG_OPPO_FINGERPRINT_PLATFORM == 6779 || CONFIG_OPPO_FINGERPRINT_PLATFORM == 6785 
    msleep(20);
#endif
