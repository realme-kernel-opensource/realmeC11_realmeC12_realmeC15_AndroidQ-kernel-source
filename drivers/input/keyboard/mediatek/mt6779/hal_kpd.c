...
#ifdef VENDOR_EDIT
//zhouhengguo@psw.bsp.driver, 2019/11/24, 19358 using pmic hw reset, other using hw gpio
...
#ifdef VENDOR_EDIT
    //zhouhengguo@psw.bsp.driver, 2019/11/24, 19358 using pmic hw reset, other using hw gpio
    if (OPPO_19354 == get_project() || OPPO_19358 == get_project() || OPPO_19359 == get_project()) {
#endif /*VENDOR_EDIT*/
...
#ifdef VENDOR_EDIT
    //zhouhengguo@psw.bsp.driver, 2019/11/24, 19357 using pmic hw reset, other using hw gpio
    }
#endif /*VENDOR_EDIT*/
#endif
}
