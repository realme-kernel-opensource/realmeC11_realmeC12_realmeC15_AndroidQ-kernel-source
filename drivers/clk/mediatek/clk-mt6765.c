...
struct pwr_status pwr_stat[NR_SYSS] = {
	[SYS_MD1] = {
			.pwr_ofs = 0x0180,
			.pwr2_ofs = 0x0184,
			.mask = MD1_PWR_STA_MASK,
			},
	[SYS_CONN] = {
			.pwr_ofs = 0x0180,
			.pwr2_ofs = 0x0184,
			.mask = CONN_PWR_STA_MASK,
			},
	[SYS_DPY] = {
			.pwr_ofs = 0x0180,
			.pwr2_ofs = 0x0184,
			.mask = DPY_PWR_STA_MASK,
			},
	[SYS_DIS] = {
			.pwr_ofs = 0x0180,
			.pwr2_ofs = 0x0184,
			.mask = DIS_PWR_STA_MASK,
			},
	[SYS_MFG] = {
			.pwr_ofs = 0x0180,
			.pwr2_ofs = 0x0184,
			.mask = MFG_PWR_STA_MASK,
			},
	[SYS_ISP] = {
			.pwr_ofs = 0x0180,
			.pwr2_ofs = 0x0184,
			.mask = ISP_PWR_STA_MASK,
			},
	[SYS_IFR] = {
			.pwr_ofs = 0x0180,
			.pwr2_ofs = 0x0184,
			.mask = IFR_PWR_STA_MASK,
			},
	[SYS_MFG_CORE0] = {
			.pwr_ofs = 0x0180,
			.pwr2_ofs = 0x0184,
			.mask = MFG_CORE0_PWR_STA_MASK,
			},
	[SYS_MFG_ASYNC] = {
			.pwr_ofs = 0x0180,
			.pwr2_ofs = 0x0184,
			.mask = MFG_ASYNC_PWR_STA_MASK,
			},
	[SYS_CAM] = {
			.pwr_ofs = 0x0180,
			.pwr2_ofs = 0x0184,
			.mask = CAM_PWR_STA_MASK,
			},
	[SYS_VCODEC] = {
			.pwr_ofs = 0x0180,
			.pwr2_ofs = 0x0184,
			.mask = VCODEC_PWR_STA_MASK,
			},
};
