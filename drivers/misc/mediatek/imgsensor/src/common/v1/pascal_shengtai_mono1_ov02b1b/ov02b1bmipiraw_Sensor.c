...
static  struct imgsensor_info_struct imgsensor_info = {
	...
	.sensor_id = PASCAL_SHENGTAI_MONO1_OV02B1B_SENSOR_ID,
		...
		do {
			...
			*sensor_id = ((read_cmos_sensor(0x02) << 8) | read_cmos_sensor(0x03));
			...
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				hardwareinfo_set_prop(HARDWARE_BACK_SUB_CAM_MOUDULE_ID, "ShengTai");
...
UINT32 OV02B1B_SHENGTAI_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
