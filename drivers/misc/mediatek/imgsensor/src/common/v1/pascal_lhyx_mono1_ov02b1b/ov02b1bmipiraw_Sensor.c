...
#include "ov02b1bmipiraw_Sensor.h"
...
static  struct imgsensor_info_struct imgsensor_info = {
	...
	.sensor_id = PASCAL_LHYX_MONO1_OV02B1B_SENSOR_ID,
 ...
 *
 *************************************************************************/
extern int pascal_project(void);
...
UINT32 OV02B1B_LHYX_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
