...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = PASCALD_SHENGTAI2_FRONT_GC5035_SENSOR_ID,
...
/* wenhui.Chen@Cam.Drv, 20200528, modify for reduce power consumption*/
	.normal_video = {
		.pclk = 175200000,
		.linelength = 2920,
		.framelength = 2008,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[7] = {
	...
	{ 2592, 1944, 16, 252, 2560,  1440,  2560,  1440, 0, 0,
...
static kal_uint16 read_cmos_sensor_shengtai2_otp(kal_uint32 addr)
{
    kal_uint16 get_byte=0;
...
static int read_gc5035_shengtai2_module_id(void)
{
	kal_uint16 gc5035_shengtai2_moduleid_id=0x0;
	gc5035_shengtai2_moduleid_id = read_cmos_sensor_shengtai2_otp(0x0000);
	printk("gc5035_shengtai2_moduleid_id = %d\n",gc5035_shengtai2_moduleid_id);
	return gc5035_shengtai2_moduleid_id;
}
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == GC5035_SENSOR_ID) {
				...
				if(read_gc5035_shengtai2_module_id() == 0x07)
				{
					*sensor_id = imgsensor_info.sensor_id;
					hardwareinfo_set_prop(HARDWARE_FRONT_CAM_MOUDULE_ID, "Shengtai2");
					pr_debug("shengtai2 gc5035 get_imgsensor_id *sensor_id = 0x%x\n",*sensor_id);
					//return ERROR_NONE;
				}
				else{
					*sensor_id = 0xFFFFFFFF;
					pr_debug("Shengtai2 match fail,so truly");
	...
	UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_PIXEL_RATE:
	{
		...
		case MSDK_SCENARIO_ID_CUSTOM1:
        		...
        		break;
		case MSDK_SCENARIO_ID_CUSTOM2:
	         	rate = (imgsensor_info.custom2.pclk /
...
UINT32 GC5035MIPI_SHENGTAI2_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	cam_pr_debug("E\n");
