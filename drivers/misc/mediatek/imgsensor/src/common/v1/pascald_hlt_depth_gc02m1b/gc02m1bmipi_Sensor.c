...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = PASCALD_HLT_DEPTH_GC02M1B_MIPI_SENSOR_ID, 
...
/*wujun@RM.Camera.Driver, 20200509, modify for dual camera framesync*/
				     ...
				     kal_uint16 target_frame_length)
{
	...
	if (imgsensor.autoflicker_en) {
		if(realtime_fps >= 297 && realtime_fps <= 305)
			...
			set_dummy();/*wujun@RM.Camera.Driver, 20200523, modify for dual camera framesync*/
	} else
		set_dummy();/*wujun@RM.Camera.Driver, 20200523, modify for dual camera framesync*/
...
kal_uint16 addr_data_pair_hlt_init_gc02m1b[] = {
...
kal_uint16 addr_data_pair_hlt_preview_gc02m1b[] = {
	0xfe, 0x00,
	0x41, 0x04,
	0x42, 0xf4,
	0xfe, 0x00,
...
kal_uint16 addr_data_pair_hlt_capture_gc02m1b[] = {
	0xfe, 0x00,
	0x41, 0x04,
	0x42, 0xf4,
	0xfe, 0x00,
...
kal_uint16 addr_data_pair_hlt_normal_video_gc02m1b[] = {
	0xfe, 0x00,
	0x41, 0x04,
	0x42, 0xf4,
	0xfe, 0x00,
...
kal_uint16 addr_data_pair_hlt_hs_video_gc02m1b[] = {
	0xfe, 0x00,
	0x41, 0x04,
	0x42, 0xf4,
	0xfe, 0x00,
...
kal_uint16 addr_data_pair_hlt_slim_video_gc02m1b[] = {
	0xfe, 0x00,
	0x41, 0x04,
	0x42, 0xf4,
	0xfe, 0x00,
...
kal_uint16 addr_data_pair_hlt_custom1_gc02m1b[] = {
	0xfe, 0x00,
	0x41, 0x06,
	0x42, 0x34,
	0xfe, 0x00,
...
kal_uint16 addr_data_pair_hlt_custom2_gc02m1b[] = {
	0xfe, 0x00,
	0x41, 0x04,
	0x42, 0xf4,
	0xfe, 0x00,
...
static void sensor_init(void)
{
	...
	gc02m1b_table_write_cmos_sensor(
		addr_data_pair_hlt_init_gc02m1b,
		sizeof(addr_data_pair_hlt_init_gc02m1b) /
		sizeof(kal_uint16));
}
...
static void preview_setting(void)
{
	LOG_INF("E\n");
	gc02m1b_table_write_cmos_sensor(
		addr_data_pair_hlt_preview_gc02m1b,
		sizeof(addr_data_pair_hlt_preview_gc02m1b) /
		sizeof(kal_uint16));
}
...
static void capture_setting(void)
{
	LOG_INF("E\n");
	gc02m1b_table_write_cmos_sensor(
		addr_data_pair_hlt_capture_gc02m1b,
		sizeof(addr_data_pair_hlt_capture_gc02m1b) /
		sizeof(kal_uint16));
}
...
static void normal_video_setting(void)
{
	LOG_INF("E\n");
	gc02m1b_table_write_cmos_sensor(
		addr_data_pair_hlt_normal_video_gc02m1b,
		sizeof(addr_data_pair_hlt_normal_video_gc02m1b) /
		sizeof(kal_uint16));
}
...
static void hs_video_setting(void)
{
	LOG_INF("E\n");
	gc02m1b_table_write_cmos_sensor(
		addr_data_pair_hlt_hs_video_gc02m1b,
		sizeof(addr_data_pair_hlt_hs_video_gc02m1b) /
		sizeof(kal_uint16));
}
...
static void slim_video_setting(void)
{
	LOG_INF("E\n");
	gc02m1b_table_write_cmos_sensor(
		addr_data_pair_hlt_slim_video_gc02m1b,
		sizeof(addr_data_pair_hlt_slim_video_gc02m1b) /
		sizeof(kal_uint16));
}
static void custom1_setting(void)
{
	LOG_INF("E\n");
	gc02m1b_table_write_cmos_sensor(
		addr_data_pair_hlt_custom1_gc02m1b,
		sizeof(addr_data_pair_hlt_custom1_gc02m1b) /
		sizeof(kal_uint16));
}
static void custom2_setting(void)
{
	LOG_INF("E\n");
	gc02m1b_table_write_cmos_sensor(
		addr_data_pair_hlt_custom2_gc02m1b,
		sizeof(addr_data_pair_hlt_custom2_gc02m1b) /
		sizeof(kal_uint16));
}
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			*sensor_id = return_sensor_id();
			...
			if (*sensor_id == GC02M1B_MIPI_SENSOR_ID) {
				if (read_cmos_sensor_eeprom(0x00) == 0x09){
	...
	UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_SET_FRAMERATE:
		...
		spin_lock(&imgsensor_drv_lock);
		/*wenhui.chen@Camera.Driver, 20200509, modify for monkey*/
