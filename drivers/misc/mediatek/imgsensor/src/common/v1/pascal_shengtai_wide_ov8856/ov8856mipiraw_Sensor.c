...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = PASCAL_SHENGTAI_WIDE_OV8856_SENSOR_ID,		/*record sensor id defined in Kd_imgsensor.h*/
	...
	.custom1 ={
		.pclk = 144000000,
		.linelength  = 1932,
		.framelength = 3104,//30,2482;24,3102
		.startx = 0,
		.starty = 0,
		.grabwindow_width  = 3264,
		.grabwindow_height = 2448,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[7] = {
	...
	/* video*/
	{ 3296, 2480,96,372, 3104, 1736, 3104, 1736, 16, 4, 3072,1728, 0, 0, 3072,1728},
	/*hight speed video */
...
/* wenhui.chen@Camera.Driver, 20200623, add for video size 3072x1728 */
kal_uint16 addr_data_pair_normal_video_ov8856[] = {
	0x3501, 0x9a,
	0x3502, 0x20,
	0x366d, 0x00,
	0x366e, 0x10,
...
{
	ov8856_table_write_cmos_sensor(addr_data_pair_normal_video_ov8856,
		sizeof(addr_data_pair_normal_video_ov8856) /
		sizeof(kal_uint16));
}
...
kal_uint16 addr_data_pair_custom2_24fps_ov8856[] = {
	0x3501, 0x9a,
	0x3502, 0x20,
	0x366d, 0x00,
	0x366e, 0x10,
...
{
    LOG_INF("E! custom1:%d\n", currefps);
    ov8856_table_write_cmos_sensor(addr_data_pair_custom2_24fps_ov8856,
                       sizeof(addr_data_pair_custom2_24fps_ov8856) /
                       sizeof(kal_uint16));
}
...
{
	kal_uint16 get_byte = 0;
	char pusendcmd[2] = {(char)(0x00 >> 8), (char)(0x00 & 0xFF)};
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			*sensor_id = ((read_cmos_sensor(0x300B) << 8) | read_cmos_sensor(0x300C));
			printk("wenhui i2c write id: *sensor_id = 0x%x\n",*sensor_id);
...
static kal_uint32 open(void)
{
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			sensor_id = ((read_cmos_sensor(0x300B) << 8) | read_cmos_sensor(0x300C));
			printk("wenhui i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id, sensor_id);
			if (sensor_id == imgsensor_info.sensor_id) {
	...
	enum MSDK_SCENARIO_ID_ENUM scenario_id, MUINT32 framerate)
{
	...
	case MSDK_SCENARIO_ID_CUSTOM2:
            		...
            		frame_length /= imgsensor_info.custom2.linelength;
            		spin_lock(&imgsensor_drv_lock);
