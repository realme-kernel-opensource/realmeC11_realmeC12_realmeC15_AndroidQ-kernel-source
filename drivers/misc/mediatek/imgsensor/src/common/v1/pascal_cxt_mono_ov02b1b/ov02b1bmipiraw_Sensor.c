...
static  struct imgsensor_info_struct imgsensor_info = {
	...
	.sensor_id = PASCAL_CXT_MONO_OV02B1B_SENSOR_ID,
			...
			*sensor_id = ((read_cmos_sensor(0x02) << 8) | read_cmos_sensor(0x03));
			...
			if (*sensor_id == OV02B1B_MIPI_SENSOR_ID) {
				*sensor_id = imgsensor_info.sensor_id;
				...
				hardwareinfo_set_prop(HARDWARE_MONO_CAM_MOUDULE_ID, "cxt");
...
UINT32 OV02B1B_CXT_MONO_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
