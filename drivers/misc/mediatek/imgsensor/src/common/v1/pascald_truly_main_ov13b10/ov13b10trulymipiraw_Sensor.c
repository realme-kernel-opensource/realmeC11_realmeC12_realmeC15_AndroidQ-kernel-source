...
#include "ov13b10trulymipiraw_Sensor.h"
...
#define OV13B10_TRULY_OTP

static DEFINE_SPINLOCK(imgsensor_drv_lock);

static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = PASCALD_TRULY_MAIN_OV13B10_SENSOR_ID,
	...
	.normal_video = {
		...
		.starty = 0,
		.grabwindow_width = 4208,
/* wenhui.Chen@Cam.Drv, 20200526, modify for reduce power consumption*/
...
/* wenhui.chen@Camera.Driver, 2020/04/26, modify for long exposure*/
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_ov13b10_truly[] = {
	0x0103, 0x01,
	0x0303, 0x01,
	0x0305, 0x43,
	0x0321, 0x00,
...
static void sensor_init(void)
{
	...
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_init_ov13b10_truly,
		sizeof(addr_data_pair_init_ov13b10_truly) / sizeof(kal_uint16));
#else
	LOG_DBG("sensor_init\n");
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_ov13b10_truly[] = {
	//0x0100, 0x00,
	0x0305, 0x23,
	0x3501, 0x06,
	0x3502, 0x10,
...
#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_preview_ov13b10_truly,
		sizeof(addr_data_pair_preview_ov13b10_truly) / sizeof(kal_uint16));
#else
//	write_cmos_sensor(0x0100, 0x00);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_15fps_ov13b10_truly[] = {
//  0x0100, 0x00,
    0x0305, 0x43,
    0x3501, 0x0c,
    0x3502, 0x10,
...
kal_uint16 addr_data_pair_capture_30fps_ov13b10_truly[] = {
//	0x0100, 0x00,
	0x0305, 0x43,
	0x3501, 0x0c,
	0x3502, 0x10,
...
static void capture_setting(kal_uint16 currefps)
{
	...
	if (currefps == 150) {
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_capture_15fps_ov13b10_truly,
		sizeof(addr_data_pair_capture_15fps_ov13b10_truly) /
		sizeof(kal_uint16));
	} else {
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_capture_30fps_ov13b10_truly,
		sizeof(addr_data_pair_capture_30fps_ov13b10_truly) /
		sizeof(kal_uint16));
	}
#else
if (currefps == 150) {
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_video_ov13b10_truly[] = {
//	0x0100, 0x00,
	0x0305, 0x43,
	0x3501, 0x0c,
	0x3502, 0x10,
...
#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_video_ov13b10_truly,
		sizeof(addr_data_pair_video_ov13b10_truly) /
		sizeof(kal_uint16));
#else
//	write_cmos_sensor(0x0100, 0x00);
	write_cmos_sensor(0x0305, 0x46);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_ov13b10_truly[] = {
    //0x0100, 0x00,
    0x0305, 0x23,
    0x3501, 0x03,
    0x3502, 0x00,
...
#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_hs_video_ov13b10_truly,
		sizeof(addr_data_pair_hs_video_ov13b10_truly) /
		sizeof(kal_uint16));
#else
    //write_cmos_sensor(0x0100, 0x00);
    write_cmos_sensor(0x0305, 0x23);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_slim_video_ov13b10_truly[] = {
    //0x0100, 0x00,
    0x0305, 0x23,
    0x3501, 0x03,
    0x3502, 0x00,
...
#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_slim_video_ov13b10_truly,
		sizeof(addr_data_pair_slim_video_ov13b10_truly) /
		sizeof(kal_uint16));
#else
    //write_cmos_sensor(0x0100, 0x00);
    write_cmos_sensor(0x0305, 0x23);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_custome1_30fps_ov13b10_truly[] = {
//	0x0100, 0x00,
	0x0305, 0x43,
	0x3501, 0x0c,
	0x3502, 0x10,
...
#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_custome1_30fps_ov13b10_truly,
		sizeof(addr_data_pair_custome1_30fps_ov13b10_truly) /
		sizeof(kal_uint16));
#endif
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_custome2_24fps_ov13b10_truly[] = {
	0x0305, 0x43,
	0x3501, 0x0c,
	0x3502, 0x10,
	0x3662, 0x92,
...
#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_custome2_24fps_ov13b10_truly,
		sizeof(addr_data_pair_custome2_24fps_ov13b10_truly) /
		sizeof(kal_uint16));
#endif
}
...
#ifdef OV13B10_TRULY_OTP
static kal_uint16 read_cmos_sensor_truly_otp(kal_uint32 addr)
{
    kal_uint16 get_byte=0;
    char pusendcmd[2] = {(char)(addr >> 8) , (char)(addr & 0xFF) };
...
static int read_ov13B10_truly_module_id(void)
{
	kal_uint16 ov13B10_truly_moduleid_id=0x0;
	ov13B10_truly_moduleid_id = read_cmos_sensor_truly_otp(0x0000);
	LOG_DBG("truly ov13B10_truly_moduleid_id = %d\n",ov13B10_truly_moduleid_id);
	return ov13B10_truly_moduleid_id;
}
#endif
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			*sensor_id = return_sensor_id();
            if (*sensor_id == OV13B10_SENSOR_ID) {
                LOG_DBG("truly ov13B10 i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
#ifdef OV13B10_TRULY_OTP
					if(read_ov13B10_truly_module_id() == 0x02)
					{
						*sensor_id = imgsensor_info.sensor_id;
						...
						LOG_DBG("truly ov13B10 get_imgsensor_id *sensor_id = 0x%x\n",*sensor_id);
						return ERROR_NONE;
					}
					else
					{
						*sensor_id = 0xFFFFFFFF;
						LOG_ERR("truly match fail,so qetch");
            ...
            LOG_ERR("truly Read sensor id fail:0x%x, id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
			retry--;
		} while (retry > 0);
		i++;
		retry = 1;
	...
	case SENSOR_FEATURE_GET_SENSOR_PDAF_CAPACITY:
		...
		case MSDK_SCENARIO_ID_CAMERA_PREVIEW:
			*(MUINT32 *) (uintptr_t) (*(feature_data + 1)) = 0;
			break;
       		case MSDK_SCENARIO_ID_CUSTOM1:
       		/*wenhui.Chen@Cam.Drv, 20200602, modify for disable PDAF */
			*(MUINT32 *)(uintptr_t)(*(feature_data+1)) = 0;
			break;
		case MSDK_SCENARIO_ID_CUSTOM2:
       		/*wenhui.Chen@Cam.Drv, 20200602, modify for disable PDAF */
...
UINT32 OV13B10_TRULY_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
