...
#include "ov13b10qtechmipiraw_Sensor.h"
...
#define OV13B10_QTECH_OTP

static DEFINE_SPINLOCK(imgsensor_drv_lock);

static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = PASCALD_QTECH_MAIN_OV13B10_SENSOR_ID,
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_ov13b10_qtech[] = {
	0x0103, 0x01,
	0x0303, 0x01,
	0x0305, 0x43,
	0x0321, 0x00,
...
static void sensor_init(void)
{
	...
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_init_ov13b10_qtech,
		sizeof(addr_data_pair_init_ov13b10_qtech) / sizeof(kal_uint16));
#else
	LOG_DBG("sensor_init\n");
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_ov13b10_qtech[] = {
	//0x0100, 0x00,
	0x0305, 0x23,
	0x3501, 0x06,
	0x3502, 0x10,
...
#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_preview_ov13b10_qtech,
		sizeof(addr_data_pair_preview_ov13b10_qtech) / sizeof(kal_uint16));
#else
//	write_cmos_sensor(0x0100, 0x00);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_15fps_ov13b10_qtech[] = {
//  0x0100, 0x00,
    0x0305, 0x43,
    0x3501, 0x0c,
    0x3502, 0x10,
...
kal_uint16 addr_data_pair_capture_30fps_ov13b10_qtech[] = {
//	0x0100, 0x00,
	0x0305, 0x43,
	0x3501, 0x0c,
	0x3502, 0x10,
...
static void capture_setting(kal_uint16 currefps)
{
	...
	if (currefps == 150) {
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_capture_15fps_ov13b10_qtech,
		sizeof(addr_data_pair_capture_15fps_ov13b10_qtech) /
		sizeof(kal_uint16));
	} else {
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_capture_30fps_ov13b10_qtech,
		sizeof(addr_data_pair_capture_30fps_ov13b10_qtech) /
		sizeof(kal_uint16));
	}
#else
if (currefps == 150) {
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_video_ov13b10_qtech[] = {
//	0x0100, 0x00,
	0x0305, 0x43,
	0x3501, 0x0c,
	0x3502, 0x10,
...
#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_video_ov13b10_qtech,
		sizeof(addr_data_pair_video_ov13b10_qtech) /
		sizeof(kal_uint16));
#else
//	write_cmos_sensor(0x0100, 0x00);
	write_cmos_sensor(0x0305, 0x46);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_ov13b10_qtech[] = {
    //0x0100, 0x00,
    0x0305, 0x23,
    0x3501, 0x03,
    0x3502, 0x00,
...
#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_hs_video_ov13b10_qtech,
		sizeof(addr_data_pair_hs_video_ov13b10_qtech) /
		sizeof(kal_uint16));
#else
    //write_cmos_sensor(0x0100, 0x00);
    write_cmos_sensor(0x0305, 0x23);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_slim_video_ov13b10_qtech[] = {
    //0x0100, 0x00,
    0x0305, 0x23,
    0x3501, 0x03,
    0x3502, 0x00,
...
#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_slim_video_ov13b10_qtech,
		sizeof(addr_data_pair_slim_video_ov13b10_qtech) /
		sizeof(kal_uint16));
#else
    //write_cmos_sensor(0x0100, 0x00);
    write_cmos_sensor(0x0305, 0x23);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_custome1_30fps_ov13b10_qtech[] = {
//	0x0100, 0x00,
	0x0305, 0x43,
	0x3501, 0x0c,
	0x3502, 0x10,
...
#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_custome1_30fps_ov13b10_qtech,
		sizeof(addr_data_pair_custome1_30fps_ov13b10_qtech) /
		sizeof(kal_uint16));
#endif
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_custome2_24fps_ov13b10_qtech[] = {
	0x0305, 0x43,
	0x3501, 0x0c,
	0x3502, 0x10,
	0x3662, 0x92,
...
#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_custome2_24fps_ov13b10_qtech,
		sizeof(addr_data_pair_custome2_24fps_ov13b10_qtech) /
		sizeof(kal_uint16));
#endif
}
...
static int read_ov13B10_qtech_module_id(void)
{
	kal_uint16 ov13B10_qtech_moduleid_id=0x0;
	ov13B10_qtech_moduleid_id = read_cmos_sensor_qtech_otp(0x0000);
	LOG_DBG("qtech ov13B10_qtech_moduleid_id = %d\n",ov13B10_qtech_moduleid_id);
	return ov13B10_qtech_moduleid_id;
}
#endif
		...
		do {
			*sensor_id = return_sensor_id();
            if (*sensor_id == OV13B10_SENSOR_ID) {
                LOG_DBG("qtech ov13B10 i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
#ifdef OV13B10_QTECH_OTP
						if(read_ov13B10_qtech_module_id() == 0x05)
						{
							*sensor_id = imgsensor_info.sensor_id;
							...
							LOG_DBG("qtech ov13B10 get_imgsensor_id *sensor_id = 0x%x\n",*sensor_id);
							return ERROR_NONE;
						}
						else
						{
							*sensor_id = 0xFFFFFFFF;
						LOG_ERR("qtech match fail,so qetch");
