...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = PASCALD_CXT_DEPTH_GC02M1B_SENSOR_ID, 
...
kal_uint16 addr_data_pair_custom1_gc02m1b[] = {
	0xfe, 0x00,
	0x41, 0x06,
	0x42, 0x34,
	0xfe, 0x00,
...
kal_uint16 addr_data_pair_custom2_gc02m1b[] = {
	0xfe, 0x00,
	0x41, 0x04,
	0x42, 0xf4,
	0xfe, 0x00,
...
static void custom2_setting(void)
{
	LOG_INF("E\n");
	gc02m1b_table_write_cmos_sensor(
		addr_data_pair_custom2_gc02m1b,
		sizeof(addr_data_pair_custom2_gc02m1b) /
		sizeof(kal_uint16));
}
...
static kal_uint8 read_cmos_sensor_8bit(kal_uint8 addr)
{
...
static void write_cmos_sensor_8bit(kal_uint8 addr, kal_uint8 para)
{
	char pu_send_cmd[2] = {(char)(addr & 0xff), (char)(para & 0xff)};
...
static kal_uint8 read_cmos_sensor_module_id(void)
{
    kal_uint8 get_byte=0;
	write_cmos_sensor_8bit(0xfc, 0x01);

	write_cmos_sensor_8bit(0xfe, 0x02);
	write_cmos_sensor_8bit(0x17, 0x80);
	write_cmos_sensor_8bit(0xf3, 0x34);
	get_byte = read_cmos_sensor_8bit(0x19);
	write_cmos_sensor_8bit(0xfe, 0x00);
	printk("read_cmos_sensor_module_id = %x\n", get_byte);
		...
		do {
			*sensor_id = return_sensor_id();
			...
			if (*sensor_id == GC02M1B_MIPI_SENSOR_ID) {
				if (read_cmos_sensor_module_id() == 0x16) {
...
UINT32 GC02M1B_CXT_D_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
