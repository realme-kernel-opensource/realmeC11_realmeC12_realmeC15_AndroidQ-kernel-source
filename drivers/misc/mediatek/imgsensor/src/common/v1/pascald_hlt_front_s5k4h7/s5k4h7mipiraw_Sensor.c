...
#define VENDOR_EDIT
#endif
/* Shipei.Chen@Cam.Drv, 20200414, otp porting for s5k4h7!*/
#ifndef S5K4H7_OTP_ENABLE
#define S5K4H7_OTP_ENABLE
#endif
...
/* Shipei.Chen@Cam.Drv, 20200414, otp porting for s5k4h7!*/
#ifdef S5K4H7_OTP_ENABLE
#define S5K4H7_MODULE_ID 0x09//hlt
extern char HLT_S5K4H7_OTP_CheckID(void);
extern void HLT_S5K4H7_OTP_Setting(void);
extern void HLT_S5K4H7_OTP_Release(void);
#endif
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = PASCALD_HLT_FRONT_S5K4H7_SENSOR_ID,	/*S5K4H7_SENSOR_ID = 0x487B */
...
#ifdef S5K4H7_OTP_ENABLE
unsigned char S5K4H7_HLT_read_cmos_sensor(u32 addr)
{
	kal_uint16 get_byte = 0;
...
void S5K4H7_HLT_write_cmos_sensor(u16 addr, u32 para)
{
...
static void write_shutter(kal_uint32 shutter)
{
	...
	if (imgsensor.autoflicker_en == KAL_TRUE) {
		...
		if (realtime_fps >= 297 && realtime_fps <= 305) {
			...
			if(litter_first) {
			    printk("test_debug 1 litter_first:%d\n", litter_first);
			    write_cmos_sensor_8(0x0340,imgsensor.frame_length >> 8);
			    write_cmos_sensor_8(0x0341,imgsensor.frame_length & 0xFF);
			}else {
			    printk("test_debug 2 litter_first:%d\n", litter_first);
			    write_cmos_sensor_8(0x0341,imgsensor.frame_length & 0xFF);
			    write_cmos_sensor_8(0x0340,imgsensor.frame_length >> 8);
			}
		}
	...
	if (pre_frame_flag == 0) {
		pre_frame_flag = 1;
		printk("test_debug first pre_frame_flag:%d\n", pre_frame_flag);
	}
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	do {
		*sensor_id = return_sensor_id();
		...
		printk("s5k4h7 get_umgsensor_id: 0x%x\n",*sensor_id );
	...
	#ifdef S5K4H7_OTP_ENABLE
	printk("HLT_S5K4H7_OTP_CheckID();\n");
	if(S5K4H7_MODULE_ID==HLT_S5K4H7_OTP_CheckID())
	{
	...
	else
	{
		...
		HLT_S5K4H7_OTP_Release();
		*sensor_id = 0xFFFFFFFF;
		return ERROR_SENSOR_CONNECT_FAIL;
	}
	printk("HLT_S5K4H7_OTP_CheckID successfully...\n");
	#endif
	return ERROR_NONE;
}
