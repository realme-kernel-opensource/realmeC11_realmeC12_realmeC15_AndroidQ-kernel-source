 ...
 *
 ****************************************************************************/
#ifndef _s5kgh1MIPI_SENSOR_H
#define _s5kgh1MIPI_SENSOR_H
...
struct imgsensor_info_struct {
	...
	struct imgsensor_mode_struct custom1;	//custom1 for VT scenario relative information
	struct imgsensor_mode_struct custom2;	//custom2 for VT scenario relative information
