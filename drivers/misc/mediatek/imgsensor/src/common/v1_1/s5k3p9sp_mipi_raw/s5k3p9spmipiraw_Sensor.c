...
static void sensor_init(void)
{
	...
	write_cmos_sensor_16_16(0x011E, 0x0101);
	#else
...
static kal_uint32 close(void)
{
	LOG_INF("E\n");
	#ifdef VENDOR_EDIT
	/*Shounan.Yang@Camera.Driver add for stream off before RST  20190620*/
							 ...
							 UINT8 *feature_para,UINT32 *feature_para_len)
{
	...
	switch (feature_id) {
	/* fuxiang@Camera.Driver 20190711 add add for ITS--sensor_fusion */
	/* YangShounan@Camera.Driver 20200217 add add for ITS--sensor_fusion */
	case SENSOR_FEATURE_GET_OFFSET_TO_START_OF_EXPOSURE:
		*(MUINT32 *)(uintptr_t)(*(feature_data + 1)) = -4010000;
		break;
	...
	*/
	...
	/* Feiping.Li@Camera.Drv, 20190601, add for sensor different size sensitivity ratio*/
