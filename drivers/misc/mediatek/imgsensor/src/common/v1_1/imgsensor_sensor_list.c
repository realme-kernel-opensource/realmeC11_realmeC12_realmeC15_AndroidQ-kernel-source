...
{IMX586_SENSOR_ID, SENSOR_DRVNAME_IMX586P2Q_MIPI_RAW, IMX586P2Q_MIPI_RAW_SensorInit},
#endif
#if defined(IMX586P2Q2_MIPI_RAW)
{IMX586_SENSOR_ID, SENSOR_DRVNAME_IMX586P2Q2_MIPI_RAW, IMX586P2Q2_MIPI_RAW_SensorInit},
#endif
#if defined(S5KGD1SP_MIPI_RAW)
{S5KGD1SP_SENSOR_ID, SENSOR_DRVNAME_S5KGD1SP_MIPI_RAW, S5KGD1SP_MIPI_RAW_SensorInit},
#endif
...
{HI846_SENSOR_ID, SENSOR_DRVNAME_HI846P2Q_MIPI_RAW, HI846P2Q_MIPI_RAW_SensorInit},
#endif
#if defined(OV02A10P2Q_MIPI_MONO)
{OV02A10_SENSOR_ID, SENSOR_DRVNAME_OV02A10P2Q_MIPI_MONO, OV02A10P2Q_MIPI_MONO_SensorInit},
#endif
#if defined(GC02M0P2Q_MIPI_MONO)
{GC02M0_SENSOR_ID, SENSOR_DRVNAME_GC02M0P2Q_MIPI_MONO, GC02M0P2Q_MIPI_MONO_SensorInit},
#endif
/* Feiping.Li@Camera.Drv, 20190603, add for 19301 two mono sensor install in any place*/
#if defined(OV02A10P2Q_MIPI_MONO1)
{OV02A10_SENSOR_ID, SENSOR_DRVNAME_OV02A10P2Q_MIPI_MONO1, OV02A10P2Q_MIPI_MONO1_SensorInit},
#endif
#if defined(GC02M0P2Q_MIPI_MONO1)
{GC02M0_SENSOR_ID, SENSOR_DRVNAME_GC02M0P2Q_MIPI_MONO1, GC02M0P2Q_MIPI_MONO1_SensorInit},
#endif
#else
