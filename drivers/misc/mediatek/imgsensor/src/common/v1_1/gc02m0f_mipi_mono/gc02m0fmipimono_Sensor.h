 ...
 *
 ****************************************************************************/
#ifndef _GC02M0F_MIPI_MONO_H
#define _GC02M0F_MIPI_MONO_H
...
typedef struct imgsensor_info_struct {
...
#ifdef VENDOR_EDIT
    /*Shounan.Yang@camera.drv 2019/6/18,modify for different module*/
    ...
    imgsensor_mode_struct custom1;    //dual cam
