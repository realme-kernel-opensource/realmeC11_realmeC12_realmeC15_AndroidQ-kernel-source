...
/*
 * BU64253TEAF voice coil motor driver
 *
 *
 */
...
#define AF_DRVNAME "BU64253TEAF_DRV"
...
/* ////////////////////////////////////////////////////////////// */
long BU64253TEAF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int BU64253TEAF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	unsigned long af_step = 25;

	LOG_INF("Start\n");
	/* Henry.Chang@Cam.Drv, 20191202, add for avoid vcm noise */
...
int BU64253TEAF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int BU64253TEAF_GetFileName(unsigned char *pFileName)
{
