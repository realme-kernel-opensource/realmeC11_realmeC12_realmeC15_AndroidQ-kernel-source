...
#ifndef VENDOR_EDIT
/*An.Wu@Cam 20200121 add MTK patch ALPS04980777 to solve ke issues*/
...
#define CCU_ASSERT(condition, fmt, args...) { \
	...
	if ((cmd != CCU_IOCTL_SET_POWER) && (cmd != CCU_IOCTL_FLUSH_LOG)
		...
		if (powert_stat == 0) {
#ifdef VENDOR_EDIT
/* Jianwei.Luo@Camera modify for lib3a.ccuif.so--NSCcuIf::CcuCtrlAf::ccu_af_control_initialize CR:ALPS04947948  20191227 */
