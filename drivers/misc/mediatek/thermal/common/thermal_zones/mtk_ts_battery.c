...
struct thermal_cooling_device *cdev, unsigned long state)
{
	...
	if (cl_dev_sysrst_state == 1) {
		 ...
		 */
#ifndef VENDOR_EDIT
/* lizhijie@BSP.CHG.Basic, 2019/11/23, lizhijie Delete for battery protect */
		BUG();
#endif
	}
	return 0;
 ...
 */
{
	...
	if (sscanf
		...
		mtktsbattery_dprintk(
			"[mtktsbattery_write] cooldev0=%s,cooldev1=%s,cooldev2=%s,cooldev3=%s,",
		...
		mtktsbattery_dprintk(
			"[mtktsbattery_write] trip_0_temp=%d,trip_1_temp=%d,trip_2_temp=%d,",
