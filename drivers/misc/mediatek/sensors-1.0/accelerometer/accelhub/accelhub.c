...
/* dadadadada */
#ifdef ODM_WT_EDIT
//qiang.ren@ODM_WT.BSP.Sensors.Config, 2020/04/22, modify for acc and gyro calibration
...
#ifdef ODM_WT_EDIT
        err = wait_for_completion_timeout(&obj->calibration_done, msecs_to_jiffies(5000));
        printk("gsensor_factory_get_cali err = %d\n",err);
#else
        err = wait_for_completion_timeout(&obj->calibration_done,
                                          msecs_to_jiffies(3000));
#endif /*ODM_WT_EDIT*/
