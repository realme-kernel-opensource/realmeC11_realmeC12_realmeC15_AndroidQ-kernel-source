...
#ifndef BUILD_LK
	register_device_proc("lcd", "S6E3FC2-MTK01", "samsung1024 cmd mode");
#endif
}
...
struct LCM_DRIVER oppo18073_samsung_ams641rw01_1080p_dsi_cmd_lcm_drv=
{
	.name = "oppo18073_samsung_ams641rw01_1080p_dsi_cmd",
