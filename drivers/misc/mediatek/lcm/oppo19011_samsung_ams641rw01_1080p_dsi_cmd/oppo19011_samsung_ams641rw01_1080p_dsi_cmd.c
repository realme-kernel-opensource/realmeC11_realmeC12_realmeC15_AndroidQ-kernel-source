...
#ifndef BUILD_LK
	register_device_proc("lcd", "S6E3FC2X03_MTK02", "samsung1024 cmd mode");
#endif
}
...
struct LCM_DRIVER oppo19011_samsung_ams641rw01_1080p_dsi_cmd_lcm_drv=
{
	.name = "oppo19011_samsung_ams641rw01_1080p_dsi_cmd",
