...
//#ifdef VENDOR_EDIT	/* Fuchun.Liao@BSP.CHG.Basic 2019/12/31 add for check fulldump */
static bool fulldump_enabled = false;
bool is_fulldump_enabled(void)
{
	return fulldump_enabled;
}
//#endif /* VENDOR_EDIT */
