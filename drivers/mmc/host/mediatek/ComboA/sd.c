...
#ifdef ODM_WT_EDIT
/* chenxu.xu@ODM_WT.BSP.Storage.Sdcard, 2020/04/03, add sd tray */
...
#ifdef ODM_WT_EDIT
//XU.CHEN@ODM_WT.BSP.Kernel.sdcard, 2020/04/17, Add for system shutdown  timeout by SD card error  
