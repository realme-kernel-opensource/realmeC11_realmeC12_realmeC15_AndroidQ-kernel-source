...
#ifdef ODM_WT_EDIT
//haibo.Dong@ODM_WT.BSP.Storage.sdcard, 2020/03/22, Modify sdcard
...
#ifndef ODM_WT_EDIT
//haibo.Dong@ODM_WT.BSP.Storage.Sdcard, 2020/03/22, Add for T-card ldo
...
#ifdef ODM_WT_EDIT
//haibo.Dong@ODM_WT.BSP.Storage.Sdcard, 2020/03/22, close sd-card Vmch
	if (host->id == 0)
	{
