...
static int __init pn553_dev_init(void)
{
	...
	if((strncmp(nfc_hardware_info,"S98635MA1",strlen("S98635MA1")) == 0)||
       (strncmp(nfc_hardware_info,"S98635NA1",strlen("S98635NA1")) == 0)||
       (strncmp(nfc_hardware_info,"S98635PA1",strlen("S98635PA1")) == 0)||
       (strncmp(nfc_hardware_info,"S98635QA1",strlen("S98635QA1")) == 0)){
