...
bool g_oppo_charge_init_done = false;
...
#endif /* VENDOR_EDIT */
#ifdef ODM_WT_EDIT
void charger_ic_enable_ship_mode(struct oppo_chg_chip *chip)
{
...
#endif /*ODM_WT_EDIT*/
#ifdef ODM_WT_EDIT
//Sidong.Zhao@WT.CHG,2020/7/1, add for pascalE
...
static int oppo_usbtemp_monitor_main(void *data)
{
	...
	while (!kthread_should_stop() && dischg_flag == false) {
		...
		if (chip->usb_temp_r < USB_50C && chip->usb_temp_l < USB_50C)//get vbus when usbtemp < 50C
			vbus_volt = oppo_battery_meter_get_battery_voltage();
		else
			vbus_volt = 0;
...
/*Sidong.Zhao@ODM_WT.BSP.CHG 2020/5/27, add for usb overtemp protection*/
	if (!g_oppo_chip) {
		chg_err("oppo_wake_up_usbtemp_thread: g_oppo_chip is NULL\n");
	} else if (g_oppo_chip->usb_overtemp_protection && (oppo_usbtemp_check_is_support() == true)) {
#else
...
void oppo_chg_default_method0(void)
{
	pr_err("charger ic default %d\n", g_oppo_chip->charger_ic__det_flag);
}

int oppo_chg_default_method1(void)
{
	return 0;
}

int oppo_chg_default_method2(int n)
{
	return 0;
}

void oppo_chg_default_method3(int n)
{

}

bool oppo_chg_default_method4(void)
{
	return false;
}
struct oppo_chg_operations  oppo_chg_default_ops = {
	.dump_registers = oppo_chg_default_method0,
	.kick_wdt = oppo_chg_default_method1,
	.hardware_init = oppo_chg_default_method1,
	.charging_current_write_fast = oppo_chg_default_method2,
	.set_aicl_point = oppo_chg_default_method3,
	.input_current_write = oppo_chg_default_method2,
	.float_voltage_write = oppo_chg_default_method2,
	.term_current_set = oppo_chg_default_method2,
	.charging_enable = oppo_chg_default_method1,
	.charging_disable = oppo_chg_default_method1,
	.get_charging_enable = oppo_chg_default_method1,
	.charger_suspend = oppo_chg_default_method1,
	.charger_unsuspend = oppo_chg_default_method1,
	.set_rechg_vol = oppo_chg_default_method2,
	.reset_charger = oppo_chg_default_method1,
	.read_full = oppo_chg_default_method1,
	.otg_enable = oppo_chg_default_method1,
	.otg_disable = oppo_chg_default_method1,
	.set_charging_term_disable = oppo_chg_default_method1,
	.check_charger_resume = oppo_chg_default_method4,

	.get_charger_type = oppo_chg_default_method1,
	.get_charger_volt = oppo_chg_default_method1,
//	int (*get_charger_current)(void);
	.get_chargerid_volt = NULL,
    .set_chargerid_switch_val = oppo_chg_default_method3,
    .get_chargerid_switch_val = oppo_chg_default_method1,
    ...
    .get_chg_current_step = oppo_chg_default_method1,
    .need_to_check_ibatt = oppo_chg_default_method4,
    .get_dyna_aicl_result = oppo_chg_default_method1,
    .get_shortc_hw_gpio_status = oppo_chg_default_method4,
//	void (*check_is_iindpm_mode) (void);
    .oppo_chg_get_pd_type = NULL,
    .oppo_chg_pd_setup = NULL,
	.get_charger_subtype = oppo_chg_default_method1,
	.set_qc_config = NULL,
...
#ifdef ODM_WT_EDIT
//Junbo.Guo@ODM_WT.BSP.CHG, 2019/11/11, Modify for subcharger
		oppo_chip->charger_ic__det_flag = get_charger_ic_det(oppo_chip);
		if (oppo_chip->charger_ic__det_flag == 0) {
			chg_err("charger IC is null, will do after bettery init.\n");
			return -EPROBE_DEFER;
		}

		if(oppo_chip->is_double_charger_support) {
			switch(oppo_chip->charger_ic__det_flag) {
				...
				default:
					...
					oppo_chip->sub_chg_ops = &oppo_chg_default_ops;
			}
		} else {
			switch(oppo_chip->charger_ic__det_flag) {
				case (1<<RT9471D):
...
#ifdef ODM_WT_EDIT
//Junbo.Guo@ODM_WT.BSP.CHG, 2020/04/10, Modify for fast node
		oppo_chip->fast_node = of_find_compatible_node(NULL, NULL,"mediatek,oppo-fastcharger");
		oppo_chip->pascale_node = of_find_compatible_node(NULL, NULL,"mediatek,oppo-pascalecharger");
#endif
...
#ifdef ODM_WT_EDIT
//Sidong.Zhao@ODM_WT.BSP.CHG, 2020/5/29, in case of use NULL pointer
	g_oppo_charge_init_done = true;
#endif /*ODM_WT_EDIT*/
