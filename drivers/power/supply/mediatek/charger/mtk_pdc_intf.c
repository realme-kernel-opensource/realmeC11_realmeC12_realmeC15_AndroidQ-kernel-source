...
{
#ifndef VENDOR_EDIT
/*lizhijie@BSP.Basic.CHG lzj add for pd charger*/
...
#define IBUS_2A	2000
#define IBUS_3A	3000
int oppo_pdc_setup(int oppo_vbus_mv, int oppo_ibus_ma)
{
	int ret = 0;
	int vbus_mv = 0;
	int ibus_ma = 0;
	...
	if (vbus_mv != VBUS_5V || ibus_ma < oppo_ibus_ma) {
